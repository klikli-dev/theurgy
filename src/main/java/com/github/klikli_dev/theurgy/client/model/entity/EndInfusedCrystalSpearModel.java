...
public class EndInfusedCrystalSpearModel extends EntityModel<EndInfusedCrystalSpearEntity> {
    //region Fields
    private final ModelRenderer pole;
    //endregion Fields

    //region Initialization
    public EndInfusedCrystalSpearModel() {
        textureWidth = 32;
        textureHeight = 32;
        ...
        pole.setTextureOffset(4, 18).addBox(-0.5F, -4.0F, -0.5F, 1.0F, 6.0F, 1.0F, 0.01F, true);
    }
    //endregion Initialization

    //region Overrides
    @Override
    public void setRotationAngles(EndInfusedCrystalSpearEntity entity, float limbSwing, float limbSwingAmount,
