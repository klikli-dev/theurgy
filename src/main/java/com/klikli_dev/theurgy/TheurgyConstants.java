    ...
    public static class I18n {
        ...
        public static class Item {
            ...
            public static class Mode {
                ...
                public static final String MERCURIAL_WAND_CYCLE_CAPACITOR_SIDE = PREFIX + "mercurial_wand.cycle_capacitor_side";
                public static final String MERCURIAL_WAND_CYCLE_CAPACITOR_SIDE_WITH_TARGET = PREFIX + "mercurial_wand.cycle_capacitor_side.with_target";
                public static final String MERCURIAL_WAND_CYCLE_CAPACITOR_SIDE_SUCCESS = PREFIX + "mercurial_wand.cycle_capacitor_side.success";
            }
        }
        ...
        public static class Behaviour {
            ...
            public static final String SELECTION_MODE_MERCURY_FLUX_EMITTER = PREFIX + "selection.mode.mercury_flux_emitter";
            public static final String SELECTION_SUMMARY_MERCURY_FLUX_EMITTER = PREFIX + "selection.summary.mercury_flux_emitter";
            public static final String SELECTION_SUMMARY_MERCURY_FLUX_EMITTER_NO_SELECTION = PREFIX + "selection.summary.mercury_flux_emitter.no_selection";
