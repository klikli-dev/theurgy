...
public class DigestionCachedCheck implements RecipeManager.CachedCheck<RecipeWrapperWithFluid, DigestionRecipe> {
    ...
    private Optional<Pair<ResourceLocation, DigestionRecipe>> getRecipeFor(ItemStack stack, Level level, @Nullable ResourceLocation lastRecipe) {
    ...
    private Optional<Pair<ResourceLocation, DigestionRecipe>> getRecipeFor(FluidStack stack, Level level, @Nullable ResourceLocation lastRecipe) {
     ...
     */
    public Optional<DigestionRecipe> getRecipeFor(ItemStack stack, Level level) {
     ...
     */
    public Optional<DigestionRecipe> getRecipeFor(FluidStack stack, Level level) {
        var optional = this.getRecipeFor(stack, level, this.lastRecipe);
        if (optional.isPresent()) {
            var pair = optional.get();
            this.lastRecipe = pair.getFirst();
     ...
     */
    @Override
    public Optional<DigestionRecipe> getRecipeFor(RecipeWrapperWithFluid container, Level level) {
