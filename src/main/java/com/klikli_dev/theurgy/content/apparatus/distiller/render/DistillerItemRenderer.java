...
public class DistillerItemRenderer extends GeoItemRenderer<DistillerBlockItem> {
    ...
    public record Unbaked() implements SpecialModelRenderer.Unbaked<GeckolibItemSpecialRenderer.RenderData<DistillerBlockItem>> {
        public static final MapCodec<Unbaked> MAP_CODEC = MapCodec.unit(new Unbaked());

        @Override
        public SpecialModelRenderer<GeckolibItemSpecialRenderer.RenderData<DistillerBlockItem>> bake(SpecialModelRenderer.BakingContext context) {
            return new GeckolibItemSpecialRenderer<>();
        }

        @Override
        public MapCodec<? extends SpecialModelRenderer.Unbaked<GeckolibItemSpecialRenderer.RenderData<DistillerBlockItem>>> type() {
            return MAP_CODEC;
        }
    }
}
