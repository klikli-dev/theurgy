...
public class IncubatorSaltVesselBEWLR extends GeoItemRenderer<IncubatorSaltVesselBlockItem> {

    private static final IncubatorSaltVesselBEWLR instance = new IncubatorSaltVesselBEWLR();
    private final ItemTransform transform;

    public IncubatorSaltVesselBEWLR() {
    ...
    public static IncubatorSaltVesselBEWLR get() {
        return instance;
    }

    @Override
    public void preRender(PoseStack poseStack, IncubatorSaltVesselBlockItem animatable, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green, float blue,
                          float alpha) {
