...
public class IncubatorSaltVesselBEWLR extends GeoItemRenderer<IncubatorSaltVesselBlockItem> {
    ...
    @Override
    public void preRender(PoseStack poseStack, IncubatorSaltVesselBlockItem animatable, BakedGeoModel model, @Nullable MultiBufferSource bufferSource, @Nullable VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int colour) {
