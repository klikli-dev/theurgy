...
public class IncubatorSaltVesselItemRenderer extends GeoItemRenderer<IncubatorSaltVesselBlockItem> {
    ...
    public record Unbaked() implements SpecialModelRenderer.Unbaked<GeckolibItemSpecialRenderer.RenderData<IncubatorSaltVesselBlockItem>> {
        public static final MapCodec<Unbaked> MAP_CODEC = MapCodec.unit(new Unbaked());

        @Override
        public SpecialModelRenderer<GeckolibItemSpecialRenderer.RenderData<IncubatorSaltVesselBlockItem>> bake(SpecialModelRenderer.BakingContext context) {
            return new GeckolibItemSpecialRenderer<>();
        }

        @Override
        public MapCodec<? extends SpecialModelRenderer.Unbaked<GeckolibItemSpecialRenderer.RenderData<IncubatorSaltVesselBlockItem>>> type() {
            return MAP_CODEC;
        }
    }
}
