...
public class MercuryFluxEmitterSelectedPoint extends SelectedPoint<MercuryFluxEmitterSelectedPoint> {
    public static final Codec<MercuryFluxEmitterSelectedPoint> CODEC = RecordCodecBuilder.create(instance -> instance.group(BlockPos.CODEC.fieldOf("blockPos").forGetter(SelectedPoint::getBlockPos)).apply(instance, MercuryFluxEmitterSelectedPoint::new));
