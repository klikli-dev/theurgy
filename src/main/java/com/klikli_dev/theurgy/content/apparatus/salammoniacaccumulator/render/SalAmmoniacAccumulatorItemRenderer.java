...
public class SalAmmoniacAccumulatorItemRenderer extends GeoItemRenderer<SalAmmoniacAccumulatorBlockItem> {
    ...
    public record Unbaked() implements SpecialModelRenderer.Unbaked<GeckolibItemSpecialRenderer.RenderData<SalAmmoniacAccumulatorBlockItem>> {
        public static final MapCodec<Unbaked> MAP_CODEC = MapCodec.unit(new Unbaked());

        @Override
        public SpecialModelRenderer<GeckolibItemSpecialRenderer.RenderData<SalAmmoniacAccumulatorBlockItem>> bake(SpecialModelRenderer.BakingContext context) {
            return new GeckolibItemSpecialRenderer<>();
        }

        @Override
        public MapCodec<? extends SpecialModelRenderer.Unbaked<GeckolibItemSpecialRenderer.RenderData<SalAmmoniacAccumulatorBlockItem>>> type() {
            return MAP_CODEC;
        }
    }
}
