...
public class SalAmmoniacAccumulatorRenderer implements BlockEntityRenderer<SalAmmoniacAccumulatorBlockEntity> {
     ...
     */
    public void render(SalAmmoniacAccumulatorBlockEntity pBlockEntity, float pPartialTick, PoseStack pPoseStack, MultiBufferSource pBufferSource, int pPackedLight, int pPackedOverlay) {
