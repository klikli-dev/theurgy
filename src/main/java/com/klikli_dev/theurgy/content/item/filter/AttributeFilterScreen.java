...
public class AttributeFilterScreen extends AbstractFilterScreen<ListFilterMenu> {
    ...
    public AttributeFilterScreen(ListFilterMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
