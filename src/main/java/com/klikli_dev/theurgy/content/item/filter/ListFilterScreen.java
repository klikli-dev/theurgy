...
public class ListFilterScreen extends TheurgyListFilterScreenBase {
    ...
    private static final int HORIZONTAL_SEPARATOR_Y = 69;
    ...
    protected void addBackgroundWidgets() {
        var tintedBackground = GuiSprites.GUI_BACKGROUND.tinted(FilterScreenStyle.BACKGROUND_TINT);
        var tintedTopBar = GuiSprites.GUI_BACKGROUND.tinted(FilterScreenStyle.TOP_BAR_TINT);
