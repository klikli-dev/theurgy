...
public class RotateSelectedDirectionModeRenderHandler extends ItemModeRenderHandler<RotateSelectedDirectionMode> {

    public RotateSelectedDirectionModeRenderHandler(RotateSelectedDirectionMode mode) {
        super(mode);
    }
