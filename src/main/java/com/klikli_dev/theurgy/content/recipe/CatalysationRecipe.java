...
public class CatalysationRecipe implements Recipe<RecipeWrapper> {
    public static final int DEFAULT_CATALYSATION_TIME = 200;
    ...
    public static final Codec<CatalysationRecipe> CODEC = RecordCodecBuilder.create(instance -> instance.group(
                    ...
                    Codec.INT.optionalFieldOf("catalysationTime", DEFAULT_CATALYSATION_TIME).forGetter(r -> r.catalysationTime)
            ).apply(instance, CatalysationRecipe::new)
    );
    protected final Ingredient ingredient;
    protected final int catalysationTime;
    protected final int mercuryFlux;
    protected ResourceLocation id;


    public CatalysationRecipe(Ingredient ingredient, int mercuryFlux, int catalysationTime) {
        this.ingredient = ingredient;
        this.catalysationTime = catalysationTime;
