...
//                """, this.itemLink("Mineral Salt", SaltRegistry.MINERAL.get()));
//
//        this.page("cost2", () -> BookTextPageModel.create()
//                .withTitle(this.context().pageTitle())
//                .withText(this.context().pageText())
//                );
//        this.pageTitle("The Cost");
...
//
//        this.page("silver_lining", () -> BookTextPageModel.create()
//                .withTitle(this.context().pageTitle())
//                .withText(this.context().pageText())
//                );
...
//
//        this.page("soul", () -> BookTextPageModel.create()
//                .withTitle(this.context().pageTitle())
//                .withText(this.context().pageText())
//                );
...
//                this.entryLink("distilled", ApparatusCategory.CATEGORY_ID, DistillerEntry.ENTRY_ID));
        ...
        this.page("next", () -> BookTextPageModel.create()
                .withTitle(this.context().pageTitle())
                .withText(this.context().pageText()));
        this.pageTitle("How?");
        this.pageText("""
