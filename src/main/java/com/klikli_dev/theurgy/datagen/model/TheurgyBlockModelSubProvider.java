...
public class TheurgyBlockModelSubProvider {
    ...
    private void registerIncubatorVessels(BlockModelGenerators blockModels, ItemModelGenerators itemModels) {
        var model = new ModelTemplate(Optional.empty(), Optional.empty(), TextureSlot.PARTICLE);
        var texture = new TextureMapping().put(TextureSlot.PARTICLE, this.mcLoc("block/copper_block"));
        var modelLoc = model.create(this.loc("block/incubator_vessel"), texture, blockModels.modelOutput);
    ...
    private void registerDigestionVat(BlockModelGenerators blockModels, ItemModelGenerators itemModels) {
        var model = new ModelTemplate(Optional.empty(), Optional.empty(), TextureSlot.PARTICLE);
        var texture = new TextureMapping().put(TextureSlot.PARTICLE, this.mcLoc("block/blue_terracotta"));
    ...
    private void registerPyromanticBrazier(BlockModelGenerators blockModels, ItemModelGenerators itemModels) {
        var unlit = new ModelTemplate(Optional.of(this.loc("block/pyromantic_brazier_template")), Optional.empty(), BASE, EMITTER)
                .create(BlockRegistry.PYROMANTIC_BRAZIER.get(), new TextureMapping()
                        .put(BASE, this.loc("block/pyromantic_brazier_base"))
                        .put(EMITTER, this.loc("block/pyromantic_brazier_bowl")), blockModels.modelOutput);

        var lit = new ModelTemplate(Optional.of(this.loc("block/pyromantic_brazier_template")), Optional.empty(), BASE, EMITTER)
                .createWithSuffix(BlockRegistry.PYROMANTIC_BRAZIER.get(), "_lit", new TextureMapping()
                        .put(BASE, this.loc("block/pyromantic_brazier_base"))
                        .put(EMITTER, this.loc("block/pyromantic_brazier_fire")), blockModels.modelOutput);
    ...
    private void registerLiquefactionCauldron(BlockModelGenerators blockModels, ItemModelGenerators itemModels) {
        ModelTemplate lowerTemplate = new ModelTemplate(Optional.of(this.loc("block/liquefaction_cauldron_template")), Optional.of("_lower"), TEXTURE, TextureSlot.PARTICLE);
        TextureMapping lowerMap = new TextureMapping()
                .put(TEXTURE, this.loc("block/liquefaction_cauldron"))
                .put(TextureSlot.PARTICLE, this.mcLoc("block/copper_block"));
    ...
    private void registerReformationSourcePedestal(BlockModelGenerators blockModels, ItemModelGenerators itemModels) {
        ModelTemplate template = new ModelTemplate(Optional.of(this.loc("block/reformation_source_pedestal_template")), Optional.empty(), TEXTURE, TextureSlot.PARTICLE);
        TextureMapping map = new TextureMapping()
                .put(TEXTURE, this.loc("block/reformation_source_pedestal"))
                .put(TextureSlot.PARTICLE, this.mcLoc("block/copper_block"));
    ...
    private void registerReformationTargetPedestal(BlockModelGenerators blockModels, ItemModelGenerators itemModels) {
        ModelTemplate template = new ModelTemplate(Optional.of(this.loc("block/reformation_target_pedestal_template")), Optional.empty(), TEXTURE, TextureSlot.PARTICLE);
        TextureMapping map = new TextureMapping()
                .put(TEXTURE, this.loc("block/reformation_target_pedestal"))
                .put(TextureSlot.PARTICLE, this.mcLoc("block/copper_block"));
    ...
    private void registerReformationResultPedestal(BlockModelGenerators blockModels, ItemModelGenerators itemModels) {
        ModelTemplate template = new ModelTemplate(Optional.of(this.loc("block/reformation_result_pedestal_template")), Optional.empty(), TEXTURE, TextureSlot.PARTICLE);
        TextureMapping map = new TextureMapping()
                .put(TEXTURE, this.loc("block/reformation_result_pedestal"))
                .put(TextureSlot.PARTICLE, this.mcLoc("block/copper_block"));
    ...
    private void registerMercuryCatalyst(BlockModelGenerators blockModels, ItemModelGenerators itemModels) {
        ModelTemplate template = new ModelTemplate(Optional.of(this.loc("block/mercury_catalyst_template")), Optional.empty(), TEXTURE, TextureSlot.PARTICLE);
        TextureMapping map = new TextureMapping()
                .put(TEXTURE, this.loc("block/mercury_catalyst"))
                .put(TextureSlot.PARTICLE, this.mcLoc("block/iron_block"));
    ...
    private void registerCaloricFluxEmitter(BlockModelGenerators blockModels, ItemModelGenerators itemModels) {
        ModelTemplate template = new ModelTemplate(Optional.of(this.loc("block/caloric_flux_emitter_template")), Optional.empty(), EMITTER, SOCKET, TextureSlot.PARTICLE);
        TextureMapping map = new TextureMapping()
                .put(EMITTER, this.loc("block/caloric_flux_emitter"))
                .put(SOCKET, this.loc("block/emitter_socket"))
                .put(TextureSlot.PARTICLE, this.loc("block/emitter_socket"));
    ...
    private void registerSulfuricFluxEmitter(BlockModelGenerators blockModels, ItemModelGenerators itemModels) {
        ModelTemplate template = new ModelTemplate(Optional.of(this.loc("block/sulfuric_flux_emitter_template")), Optional.empty(), EMITTER, SOCKET, TextureSlot.PARTICLE);
        TextureMapping map = new TextureMapping()
                .put(EMITTER, this.loc("block/sulfuric_flux_emitter"))
                .put(SOCKET, this.loc("block/emitter_socket"))
                .put(TextureSlot.PARTICLE, this.loc("block/emitter_socket"));
    ...
    private void registerIncubator(BlockModelGenerators blockModels, ItemModelGenerators itemModels) {
        var lowerHalfModel = new ModelTemplate(Optional.of(this.loc("block/incubator_template")), Optional.empty(), TEXTURE, TextureSlot.PARTICLE)
                .create(BlockRegistry.INCUBATOR.get(), new TextureMapping()
                        .put(TEXTURE, this.loc("block/incubator_gold"))
        ...
        var pipeModel = new ModelTemplate(Optional.of(this.loc("block/incubator_pipe_template")), Optional.of("_pipe"), TEXTURE, TextureSlot.PARTICLE)
                .create(BlockRegistry.INCUBATOR.get(), new TextureMapping()
                        .put(TEXTURE, this.loc("block/incubator_pipe"))
                        .put(TextureSlot.PARTICLE, this.mcLoc("block/copper_block")), blockModels.modelOutput);
        ...
        for (Direction dir : Direction.Plane.HORIZONTAL) {
            generator.with(Condition.and(
                    ...
                    Variant.variant().with(VariantProperties.MODEL, pipeModel)
                            .with(VariantProperties.Y_ROT, this.getRotation((int) dir.toYRot() + 180))
    ...
    private void registerFermentationVat(BlockModelGenerators blockModels, ItemModelGenerators itemModels) {
        TextureMapping closedMap = new TextureMapping()
                .put(TextureSlot.UP, this.loc("block/fermentation_vat_top"))
                .put(TextureSlot.DOWN, this.loc("block/fermentation_vat_bottom"))
                .put(TextureSlot.SOUTH, this.loc("block/fermentation_vat_side_front"))
                .put(TextureSlot.NORTH, this.loc("block/fermentation_vat_side"))
                .put(TextureSlot.WEST, this.loc("block/fermentation_vat_side"))
                .put(TextureSlot.EAST, this.loc("block/fermentation_vat_side"))
                .put(TextureSlot.PARTICLE, this.loc("block/fermentation_vat_side"));
        ...
        TextureMapping mapOpen = new TextureMapping().put(TextureSlot.UP, this.loc("block/fermentation_vat_top_open"));
        ...
        TextureMapping mapActive = new TextureMapping().put(TextureSlot.SOUTH, this.loc("block/fermentation_vat_side_front_active"));
                ...
                for (boolean output : List.of(false, true)) {
                    ...
                    generator.with(Condition.condition()
                            ...
                            Variant.variant()
                                    ...
                                    .with(VariantProperties.Y_ROT, this.getRotation((int) dir.toYRot())));
                }
            }
        }
    ...
    private ResourceLocation registerLogisticsFilterModel(BlockModelGenerators blockModels) {
        ModelTemplate template = new ModelTemplate(Optional.of(this.loc("block/logistics_connector_filter_template")), Optional.of("_filter"), TEXTURE, TextureSlot.PARTICLE);
        TextureMapping map = new TextureMapping()
                .put(TEXTURE, this.loc("block/logistics_connector_filter"))
                .put(TextureSlot.PARTICLE, this.mcLoc("block/iron_block"));
        return template.create(this.loc("block/logistics_connector_filter"), map, blockModels.modelOutput);
    }
    ...
    private void registerLogisticsItemInserter(BlockModelGenerators blockModels, ItemModelGenerators itemModels, ResourceLocation filter) {
        this.registerLogisticsBlock(blockModels, itemModels, BlockRegistry.LOGISTICS_ITEM_INSERTER.get(), "block/logistics_item_inserter", filter);
    }
    ...
    private void registerLogisticsItemExtractor(BlockModelGenerators blockModels, ItemModelGenerators itemModels, ResourceLocation filter) {
        this.registerLogisticsBlock(blockModels, itemModels, BlockRegistry.LOGISTICS_ITEM_EXTRACTOR.get(), "block/logistics_item_extractor", filter);
    }
    ...
    private void registerLogisticsFluidInserter(BlockModelGenerators blockModels, ItemModelGenerators itemModels, ResourceLocation filter) {
        this.registerLogisticsBlock(blockModels, itemModels, BlockRegistry.LOGISTICS_FLUID_INSERTER.get(), "block/logistics_fluid_inserter", filter);
    }
    ...
    private void registerLogisticsFluidExtractor(BlockModelGenerators blockModels, ItemModelGenerators itemModels, ResourceLocation filter) {
        this.registerLogisticsBlock(blockModels, itemModels, BlockRegistry.LOGISTICS_FLUID_EXTRACTOR.get(), "block/logistics_fluid_extractor", filter);
    }
    ...
    private void registerLogisticsBlock(BlockModelGenerators blockModels, ItemModelGenerators itemModels, Block block, String texturePath, ResourceLocation filter) {
        var model = new ModelTemplate(Optional.of(this.loc("block/logistics_connector_template")), Optional.empty(), TEXTURE, TextureSlot.PARTICLE)
        ...
        for (Direction dir : Direction.values()) {
            ...
            generator.with(Condition.condition().term(BlockStateProperties.FACING, dir),
                    Variant.variant().with(VariantProperties.MODEL, model)
                            ...
                            .with(VariantProperties.Y_ROT, this.getRotation(yRot))
            );
    ...
    private void registerLogisticsNode(BlockModelGenerators blockModels, ItemModelGenerators itemModels) {
        var model = new ModelTemplate(Optional.of(this.loc("block/logistics_node_template")), Optional.empty(), CONNECTOR, BASE, TextureSlot.PARTICLE)
                .create(BlockRegistry.LOGISTICS_CONNECTION_NODE.get(), new TextureMapping()
                        .put(CONNECTOR, this.loc("block/logistics_node_connector"))
                        .put(BASE, this.loc("block/logistics_node_base"))
                        .put(TextureSlot.PARTICLE, this.mcLoc("block/terracotta")), blockModels.modelOutput);
