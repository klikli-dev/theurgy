...
public class IncubationRecipeProvider extends JsonRecipeProvider {
    ...
    public IncubationRecipeProvider(PackOutput packOutput, CompletableFuture<HolderLookup.Provider> lookupProvider) {
    ...
    public void buildRecipes(BiConsumer<Identifier, JsonObject> recipeConsumer) {
        ...
        this.makeRecipe(net.minecraft.core.registries.BuiltInRegistries.BLOCK.get(net.minecraft.resources.Identifier.withDefaultNamespace("white_wool")).orElseThrow().value().asItem(), ItemRegistry.MERCURY_SHARD.get(), SaltRegistry.CREATURE.get(), SulfurRegistry.WOOL.get());
        ...
        this.makeRecipe(ItemTagRegistry.INGOTS_MITHRIL, ItemRegistry.MERCURY_SHARD.get(), SaltRegistry.MINERAL.get(), SulfurRegistry.MITHRIL.get());
        this.makeRecipe(ItemTagRegistry.INGOTS_STELLARITE, ItemRegistry.MERCURY_SHARD.get(), SaltRegistry.MINERAL.get(), SulfurRegistry.STELLARITE.get());
        ...
        this.makeRecipe(ItemTagRegistry.GEMS_CINNABAR, ItemRegistry.MERCURY_SHARD.get(), SaltRegistry.MINERAL.get(), SulfurRegistry.CINNABAR.get());
