...
public class IncubationRecipeProvider extends JsonRecipeProvider {
    ...
    public void buildRecipes(BiConsumer<ResourceLocation, JsonObject> recipeConsumer) {
        ...
        //    public static final DeferredItem<AlchemicalSulfurItem> COBBLESTONE_DEEPSLATE = registerForSourceTag(Tags.Items.COBBLESTONES_DEEPSLATE, AlchemicalDerivativeTier.ABUNDANT, AlchemicalSulfurType.EARTHEN_MATTERS);
        //
        ...
        //    public static final DeferredItem<AlchemicalSulfurItem> CONCRETE = registerForSourceItem(Items.WHITE_CONCRETE, AlchemicalDerivativeTier.COMMON, AlchemicalSulfurType.EARTHEN_MATTERS);
        this.makeRecipe(Items.DIRT, ItemRegistry.MERCURY_SHARD.get(), SaltRegistry.MINERAL.get(), SulfurRegistry.DIRT.get());
        this.makeRecipe(Items.COARSE_DIRT, ItemRegistry.MERCURY_SHARD.get(), SaltRegistry.MINERAL.get(), SulfurRegistry.COARSE_DIRT.get());
        this.makeRecipe(Items.PODZOL, ItemRegistry.MERCURY_SHARD.get(), SaltRegistry.MINERAL.get(), SulfurRegistry.PODZOL.get());
        this.makeRecipe(Items.GRASS_BLOCK, ItemRegistry.MERCURY_SHARD.get(), SaltRegistry.MINERAL.get(), SulfurRegistry.GRASS_BLOCK.get());
        this.makeRecipe(Items.ROOTED_DIRT, ItemRegistry.MERCURY_SHARD.get(), SaltRegistry.MINERAL.get(), SulfurRegistry.ROOTED_DIRT.get());
        this.makeRecipe(Items.MOSS_BLOCK, ItemRegistry.MERCURY_SHARD.get(), SaltRegistry.MINERAL.get(), SulfurRegistry.MOSS_BLOCK.get());
        this.makeRecipe(Items.MUD, ItemRegistry.MERCURY_SHARD.get(), SaltRegistry.MINERAL.get(), SulfurRegistry.MUD.get());
        this.makeRecipe(Items.MUDDY_MANGROVE_ROOTS, ItemRegistry.MERCURY_SHARD.get(), SaltRegistry.MINERAL.get(), SulfurRegistry.MUDDY_MANGROVE_ROOTS.get());
        this.makeRecipe(Items.SAND, ItemRegistry.MERCURY_SHARD.get(), SaltRegistry.MINERAL.get(), SulfurRegistry.SAND.get());
        this.makeRecipe(Items.RED_SAND, ItemRegistry.MERCURY_SHARD.get(), SaltRegistry.MINERAL.get(), SulfurRegistry.RED_SAND.get());
        this.makeRecipe(Items.GRAVEL, ItemRegistry.MERCURY_SHARD.get(), SaltRegistry.MINERAL.get(), SulfurRegistry.GRAVEL.get());
        this.makeRecipe(Items.NETHERRACK, ItemRegistry.MERCURY_SHARD.get(), SaltRegistry.MINERAL.get(), SulfurRegistry.NETHERRACK.get());
        this.makeRecipe(Items.SOUL_SAND, ItemRegistry.MERCURY_SHARD.get(), SaltRegistry.MINERAL.get(), SulfurRegistry.SOUL_SAND.get());
        this.makeRecipe(Items.SOUL_SOIL, ItemRegistry.MERCURY_SHARD.get(), SaltRegistry.MINERAL.get(), SulfurRegistry.SOUL_SOIL.get());
        this.makeRecipe(Items.STONE, ItemRegistry.MERCURY_SHARD.get(), SaltRegistry.MINERAL.get(), SulfurRegistry.STONE.get());
        this.makeRecipe(Items.INFESTED_STONE, ItemRegistry.MERCURY_SHARD.get(), SaltRegistry.MINERAL.get(), SulfurRegistry.INFESTED_STONE.get());
        this.makeRecipe(Items.COBBLESTONE, ItemRegistry.MERCURY_SHARD.get(), SaltRegistry.MINERAL.get(), SulfurRegistry.COBBLESTONE.get());
        this.makeRecipe(Items.MOSSY_COBBLESTONE, ItemRegistry.MERCURY_SHARD.get(), SaltRegistry.MINERAL.get(), SulfurRegistry.COBBLESTONE_MOSSY.get());
        this.makeRecipe(Items.INFESTED_COBBLESTONE, ItemRegistry.MERCURY_SHARD.get(), SaltRegistry.MINERAL.get(), SulfurRegistry.COBBLESTONES_INFESTED.get());
        this.makeRecipe(Items.DEEPSLATE, ItemRegistry.MERCURY_SHARD.get(), SaltRegistry.MINERAL.get(), SulfurRegistry.DEEPSLATE.get());
        this.makeRecipe(Items.COBBLED_DEEPSLATE, ItemRegistry.MERCURY_SHARD.get(), SaltRegistry.MINERAL.get(), SulfurRegistry.COBBLESTONE_DEEPSLATE.get());
        this.makeRecipe(Items.GRANITE, ItemRegistry.MERCURY_SHARD.get(), SaltRegistry.MINERAL.get(), SulfurRegistry.GRANITE.get());
        this.makeRecipe(Items.DIORITE, ItemRegistry.MERCURY_SHARD.get(), SaltRegistry.MINERAL.get(), SulfurRegistry.DIORITE.get());
        this.makeRecipe(Items.ANDESITE, ItemRegistry.MERCURY_SHARD.get(), SaltRegistry.MINERAL.get(), SulfurRegistry.ANDESITE.get());
        this.makeRecipe(Items.BLACKSTONE, ItemRegistry.MERCURY_SHARD.get(), SaltRegistry.MINERAL.get(), SulfurRegistry.BLACKSTONE.get());
        this.makeRecipe(Items.BASALT, ItemRegistry.MERCURY_SHARD.get(), SaltRegistry.MINERAL.get(), SulfurRegistry.BASALT.get());
        this.makeRecipe(Items.SANDSTONE, ItemRegistry.MERCURY_SHARD.get(), SaltRegistry.MINERAL.get(), SulfurRegistry.SANDSTONE.get());
        this.makeRecipe(Items.RED_SANDSTONE, ItemRegistry.MERCURY_SHARD.get(), SaltRegistry.MINERAL.get(), SulfurRegistry.RED_SANDSTONE.get());
        this.makeRecipe(Items.CLAY_BALL, ItemRegistry.MERCURY_SHARD.get(), SaltRegistry.MINERAL.get(), SulfurRegistry.CLAY.get());
        this.makeRecipe(Items.TERRACOTTA, ItemRegistry.MERCURY_SHARD.get(), SaltRegistry.MINERAL.get(), SulfurRegistry.TERRACOTTA.get());
        this.makeRecipe(Items.CRIMSON_NYLIUM, ItemRegistry.MERCURY_SHARD.get(), SaltRegistry.MINERAL.get(), SulfurRegistry.CRIMSON_NYLIUM.get());
        this.makeRecipe(Items.WARPED_NYLIUM, ItemRegistry.MERCURY_SHARD.get(), SaltRegistry.MINERAL.get(), SulfurRegistry.WARPED_NYLIUM.get());
