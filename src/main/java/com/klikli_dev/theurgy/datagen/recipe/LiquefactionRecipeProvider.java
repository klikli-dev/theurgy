...
public class LiquefactionRecipeProvider extends JsonRecipeProvider {
    ...
    public void buildRecipes(BiConsumer<ResourceLocation, JsonObject> recipeConsumer) {
        ...
        this.makeRecipe(SulfurRegistry.TURTLE_SCUTE.get(), Items.SCUTE, salAmmoniac, 20);
        ...
        this.makeRecipe(SulfurRegistry.SAND.get(), Tags.Items.SAND_COLORLESS, salAmmoniac, 10);
        this.makeRecipe(SulfurRegistry.RED_SAND.get(), Tags.Items.SAND_RED, salAmmoniac, 10);
        this.makeRecipe(SulfurRegistry.GRAVEL.get(), Items.GRAVEL, salAmmoniac, 10);
        this.makeRecipe(SulfurRegistry.NETHERRACK.get(), Tags.Items.NETHERRACK, salAmmoniac, 10);
        ...
        this.makeRecipe(SulfurRegistry.COBBLESTONE.get(), Tags.Items.COBBLESTONE_NORMAL, salAmmoniac, 10);
        this.makeRecipe(SulfurRegistry.COBBLESTONE_MOSSY.get(), Tags.Items.COBBLESTONE_MOSSY, salAmmoniac, 10);
        this.makeRecipe(SulfurRegistry.COBBLESTONE_INFESTED.get(), Tags.Items.COBBLESTONE_INFESTED, salAmmoniac, 10);

        this.makeRecipe(SulfurRegistry.DEEPSLATE.get(), Items.DEEPSLATE, salAmmoniac, 10);
        this.makeRecipe(SulfurRegistry.COBBLESTONE_DEEPSLATE.get(), Tags.Items.COBBLESTONE_DEEPSLATE, salAmmoniac, 10);
    ...
    public void makeRecipe(Item sulfur, int resultCount, Item ingredient, Fluid solvent, int solventAmount, int liquefactionTime) {
        ...
        this.recipeConsumer.accept(
                this.modLoc(this.name(sulfur) + "_from_" + this.name(ingredient)),
                this.makeRecipeJson(
