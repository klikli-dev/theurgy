...
public class DataComponentRegistry {
    ...
    public static final DeferredHolder<DataComponentType<?>, DataComponentType<Holder<Item>>> SOURCE_ITEM = DATA_COMPONENTS.registerComponentType("source_item", builder -> builder
            .persistent(BuiltInRegistries.ITEM.holderByNameCodec())
            .networkSynchronized(ByteBufCodecs.holderRegistry(Registries.ITEM))
            .cacheEncoding()
    );

    public static final DeferredHolder<DataComponentType<?>, DataComponentType<TagKey<Item>>> SOURCE_TAG = DATA_COMPONENTS.registerComponentType("source_tag", builder -> builder
